...
> **RV University**  
> *Repository:* [charukeshgbsc24-lgtm/campus-connect-portal-2](https://github.com/charukeshgbsc24-lgtm/campus-connect-portal-2)
...
```bash
git clone https://github.com/MedhaSrinath/Campus-connect.git
cd Campus-connect
```
